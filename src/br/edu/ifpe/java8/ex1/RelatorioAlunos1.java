...
/**
 * Esta classe é responsável pela leitura de todos os alunos de um arquivo de
 * entrada (alunos.txt) e gerar um relatório.
 * 
 * 4 Opções de relatórios estão disponíveis: 1 - Com o nome de todos os alunos;
 * 2 - Apenas com os nomes dos alunos aprovados; 3 - Apenas com os nomes dos
 * alunos que foram para a final; 4 - Apenas com os nomes dos alunos que foram
 * reprovados
 *
 * O problema do código abaixo (entre outros) é que ele viola o princípio
 * OPEN-CLOSED de OO, que diz que o entidades devem estar aberta para extensões,
 * porém fechadas para mudanças.
 * 
 * Logo, o seu trabalho é basicamente, utilizando programação funcional,
 * modificar o mecanismo de geração de relatórios para evitar ifs e switchs ao
 * longo do método abaixo.
 * 
 * @author Victor Lira
 *
 */
